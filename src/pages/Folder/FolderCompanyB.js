...
export const FolderCompanyB = observer((props) => {
            ...
            render: (text, record) =>
                <div style={{ display: 'flex', gap: '1em', justifyContent: "center" }}>
                    <Button
                        ...
                        size="small"
                        icon={<EditOutlined />}
                        onClick={() => history.push('/edit-document')}
                    >
                        {/* Edit */}
                    </Button>
                </div>
